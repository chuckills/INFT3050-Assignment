                ...
                <asp:Table ID="tblProduct" runat="server">
                    ...
                    <asp:TableRow runat="server">
                        ...
                        <asp:TableCell runat="server">
                            <asp:DropDownList ID="ddlTeam" CssClass="form-control" runat="server" DataSourceID="dsTeams" DataTextField="teamFull" DataValueField="teamID" OnDataBound="addDefaultItem"></asp:DropDownList>
