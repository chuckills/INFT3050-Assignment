<%@ Page Title="Shop" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Products.aspx.cs" Inherits="Assignment_1.Products" %>
    ...
    <div class="container">
        <div class="row margin-space-top-20">
            <div class="col-sm">
                ...
                <div class="d-flex justify-content-center">
                    <asp:LinkButton ID="LinkButton1" runat="server" postbackurl="~/SingleProductPage"  
            ...
            <div class="col-sm">
                ...
                <h3 class="product-price-title">$100</h3>
                <div class="d-flex justify-content-center">
                    <asp:LinkButton ID="LinkButton2" runat="server" postbackurl="~/SingleProductPage"  
                        class="product-buy-btn btn btn-danger">Buy</asp:LinkButton>
                </div> 
            </div>
            <div class="col-sm">
                ...
                <h3 class="product-price-title">$100</h3>
                <div class="d-flex justify-content-center">
                    <asp:LinkButton ID="LinkButton3" runat="server" postbackurl="~/SingleProductPage"  
                        class="product-buy-btn btn btn-danger">Buy</asp:LinkButton>
                </div> 
            </div>
            <div class="col-sm">
                ...
                <h3 class="product-price-title">$100</h3>
                <div class="d-flex justify-content-center">
                    <asp:LinkButton ID="LinkButton4" runat="server" postbackurl="~/SingleProductPage"  
                        class="product-buy-btn btn btn-danger">Buy</asp:LinkButton>
                </div> 
            </div>
        </div>
        <div class="row margin-space-top-50 padding-bottom-15">
            <div class="col-sm">
                ...
                <h3 class="product-price-title">$100</h3>
                <div class="d-flex justify-content-center">
                    <asp:LinkButton ID="LinkButton5" runat="server" postbackurl="~/SingleProductPage"  
                        class="product-buy-btn btn btn-danger">Buy</asp:LinkButton>
                </div> 
            </div>
            <div class="col-sm">
                ...
                <h3 class="product-price-title">$100</h3>
                <div class="d-flex justify-content-center">
                    <asp:LinkButton ID="LinkButton6" runat="server" postbackurl="~/SingleProductPage"  
                        class="product-buy-btn btn btn-danger">Buy</asp:LinkButton>
                </div> 
            </div>
            <div class="col-sm">
                ...
                <h3 class="product-price-title">$100</h3>
                <div class="d-flex justify-content-center">
                    <asp:LinkButton ID="LinkButton7" runat="server" postbackurl="~/SingleProductPage"  
                        class="product-buy-btn btn btn-danger">Buy</asp:LinkButton>
                </div> 
            </div>
            <div class="col-sm">
                ...
                <h3 class="product-price-title">$100</h3>
                <div class="d-flex justify-content-center">
                    <asp:LinkButton ID="LinkButton8" runat="server" postbackurl="~/SingleProductPage"  
                        class="product-buy-btn btn btn-danger">Buy</asp:LinkButton>
                </div> 
            </div>
        </div>
